defmodule GamePicker do
  ...
  ## Examples
      iex> games = [%Game{name: "Game1", min_players: 2, max_players: 4}, %Game{name: "Game2", min_players: 4, max_players: 10}, %Game{name: "Game3", min_players: 6, max_players: 12}]
      iex> GamePicker.pick_game(games, 5)
      %Game{name: "Game2", min_players: 4, max_players: 10}
  """
  def pick_game(games, num_players) do
    filter_min_players(games, num_players)
  ...
  ## Examples
      iex> games = [%Game{name: "Game1", min_players: 2, max_players: 4}, %Game{name: "Game2", min_players: 3, max_players: 5}]
